...
<table width="<?php echo $ancho_tabla ?>" border="1">
  <tr>
    ...
    <td id = "fondo_casilla"><id id ="letrero">CREACION DE FACTURAS</div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="empresa" id="empresa" type="text" onfocus="blur();"></td>
	  <td>ID</td>
       ...
       <div id ="letra_roja">FACTURA No
       	<input type="text" id="no_cotizacion" value= "<?php echo $numero_cot;  ?>" onfocus="blur();" size="20px">
       	 </div>
...
OBSERVACIONES : <BR>
<input type = "text" id = "observaciones" size="80px" class="fila_llenar" >
<br><br>
	<button id="btn_crear_cotizacion" type ="submit">CREAR FACTURA</button>
</div>	
<div id="div_encabezado_items">
	...
	<div id="finalizar" align="center">
		<br>
		<button id="finalizar_cotizacion">FINALIZAR FACTURA</button>
	</div>	
</div>
