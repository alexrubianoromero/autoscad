...
mecanico,id_factura
 ...
 from $tabla14  where id_empresa = '".$_SESSION['id_empresa']."' and tipo_orden < '20' and anulado = '0'  order by id desc limit 100";
		...
		while($ordenes = mysql_fetch_array($consulta_ordenes))

			{
				...
				echo '<td><h3>';
      			if($ordenes['8']<1)
      			{	
						echo'<a href="../orden/facturar_orden.php?idorden='.$ordenes['0'].'">Facturar</a>';
				}
				else
				{
